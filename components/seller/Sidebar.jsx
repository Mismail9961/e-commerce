  ...
  const adminOnlyMenuItems = [
    {
      name: "All Users",
      path: "/seller/users",
      icon: assets.user_icon || assets.add_icon,
    },
    {
      name: "SEO Settings",
      path: "/seller/seo",
      icon: assets.seo_icon || assets.add_icon,
    },
    {
      name: "Category SEO",
  ...
  return (
    <div className="w-14 xs:w-16 sm:w-20 md:w-64 bg-gradient-to-b from-[#001d2e] to-[#003049] min-h-screen border-r border-white/10 flex flex-col py-2 sm:py-3 md:py-4 shadow-2xl">
                ...
                >
                  <Image
                    ...
                    className={`w-5 h-5 sm:w-6 sm:h-6 ${
                      isActive
                        ? "brightness-0 invert"
                        : "brightness-75 invert opacity-70 group-hover:opacity-100"
                    }`}
                  />
                </div>
      ...
      <div className="px-1.5 sm:px-2 md:px-4 py-2 sm:py-3 mt-2 sm:mt-3 md:mt-4 border-t border-white/10">
        <div
          className={`px-1.5 sm:px-2 md:px-3 py-1.5 sm:py-2 rounded-md sm:rounded-lg text-center ${
            userRole === "admin"
        ...
        >
          <p className="text-[10px] xs:text-xs font-semibold uppercase tracking-wider">
            <span
              className={userRole === "admin" ? "text-[#9d0208]" : "text-white"}
            >
