...
const Banner = () => {
  return (
    <div className="relative flex flex-col md:flex-row items-center justify-between md:pl-12 lg:pl-20 py-8 min-[375px]:py-10 sm:py-14 md:py-0 
          bg-gradient-to-r from-[#00b4d8] via-[#03045e] to-[#00b4d8] 
          overflow-hidden my-8 min-[375px]:my-10 sm:my-12 lg:my-16 shadow-xl">
      
      {/* Decorative Background Elements */}
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_50%,_rgba(0,180,216,0.15)_0%,_transparent_50%)]"></div>
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_70%_50%,_rgba(3,4,94,0.15)_0%,_transparent_50%)]"></div>
      
      <Image
        className="w-40 min-[375px]:w-48 sm:w-56 md:w-64 relative z-10 drop-shadow-2xl"
      ...
      <div className="flex flex-col items-center justify-center text-center space-y-3 min-[375px]:space-y-4 px-4 sm:px-6 md:px-0 relative z-10">
        ...
        <button className="group flex items-center justify-center gap-2 
              ...
              bg-white hover:bg-[#00b4d8] 
              text-[#03045e] hover:text-white 
              font-semibold 
      ...
      <Image
        className="hidden md:block w-64 lg:w-80 relative z-10 drop-shadow-2xl"
        src={assets.md_controller_image}
        alt="md_controller_image"
      />
      
      <Image
        className="md:hidden w-48 min-[375px]:w-56 sm:w-64 relative z-10 mt-6 sm:mt-8 drop-shadow-2xl"
