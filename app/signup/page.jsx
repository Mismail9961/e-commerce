      ...
      <div className="max-w-md w-full">
        <div className="bg-white rounded-xl sm:rounded-2xl shadow-2xl p-6 sm:p-8 border border-gray-100">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  type="text"
                  required
                  className="block w-full pl-9 sm:pl-10 pr-3 py-2.5 sm:py-3 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#EA580C] focus:border-transparent transition"
          ...
          <button
            ...
            className="w-full flex justify-center items-center gap-2 sm:gap-3 py-2.5 sm:py-3 px-4 border-2 border-gray-200 rounded-lg shadow-sm bg-white hover:bg-gray-50 hover:border-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#EA580C] transition transform hover:scale-[1.02] active:scale-[0.98]"
          >
